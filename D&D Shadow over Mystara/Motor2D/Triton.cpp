...
Triton::Triton() :Entity(TRITON)
{
	...
	{
		pugi::xml_node anim = data.child("Entities").child("Triton").child("Animations").child("Idle").child("frame");
		...
		LoadProperties(data.child("Entities").child("Triton").child("Statistics"));
