...
void Triton::Attack()
{
	App->audio->PlayFx(App->audio->triton_attack_fx, 0);

}

void  Triton::Death() {
	App->audio->PlayFx(App->audio->triton_death_fx, 0);
}
void  Triton::Run() {
	App->audio->PlayFx(App->audio->triton_run_fx, 0);
}
void  Triton::Damaged() {
	App->audio->PlayFx(App->audio->triton_damaged_fx, 0);
}
