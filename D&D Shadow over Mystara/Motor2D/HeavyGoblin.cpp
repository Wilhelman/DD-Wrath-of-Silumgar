#include "HeavyGoblin.h"



HeavyGoblin::HeavyGoblin() :Entity(HEAVYGOBLIN)
{
	...
	if (pugi::xml_parse_result result = data.load_file("Entities.xml"))
	{
		...
		LoadProperties(data.child("Entities").child("HeavyGoblin").child("Statistics"));
